...
//geting course material by course Id and Grade
   List<courseMaterial> getCourseMaterialByCourseAndGrade(String courseId, int grade) {
    return _items.where((material) => material.courseId == courseId && material.grade == grade).toList();
  }

  //upload Course Material to firestorage and firebase
  Future<String> uploadCourseMaterial(String title, String description, int grade,
    ...
    try {
      ...
      _firestore.collection("Student Materials").doc(courseMaterialId).set(CourseMaterial.toJson());
